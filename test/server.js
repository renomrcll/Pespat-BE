...
describe('GET /users/:id', () => {
    it('it should return user data', (done) => {
        const token = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiTG95ZCIsImVtYWlsIjoibG95ZEBnbWFpbC5jb20iLCJpYXQiOjE2NTM5MTYwNjAsImV4cCI6MTY1MzkxODIxNX0.oeySkuFfpkci4jsW98ztOGcy2BsKFs_EJSQG4JI8ud8'
        chai
            .request(server)
            .get('/hnGpxuPp7VpMbBhpilEi')
